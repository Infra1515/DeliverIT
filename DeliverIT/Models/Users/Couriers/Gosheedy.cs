...
namespace DeliverIT.Models.Users.Couriers
{
    ...
    {
        private const string username = "Gosheedy";
        ...
        public Gosheedy() : base(firstName, lastName, email, phoneNumber, years, address,
            gender, allowedWeight, allowedVolume, username)
        {
        }
    }
}
